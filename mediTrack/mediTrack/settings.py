...
#manual
LOGIN_URL = '/auth/login/'  # Change this to your actual login URL
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "ay348177@gmail.com"  # Replace with your email
EMAIL_HOST_PASSWORD = "wevr vxsg plvo gnrj"  # Generate an app password from Google
